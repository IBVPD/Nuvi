...
//        $this->assertEquals($mapBuilder->camelCase($columns[3]->getName()), $columns[3]->getMapper());
    ...
    private function getConverterRegistry()
    {
        $converters = array(
            ...
            'ns.sentinel.converter.rotavirusDischargeOutcome'     => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\DischargeOutcome'),
            'ns.sentinel.converter.rehydration'                   => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\Rehydration'),
            'ns.sentinel.converter.pathogenIdentifier'            => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\PathogenIdentifier'),
            'ns.sentinel.converter.pcvType'                       => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\PCVType'),
            'ns.sentinel.converter.pcrResult'                     => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\PCRResult'),
            'ns.sentinel.converter.otherSpecimen'                 => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\OtherSpecimen'),
            'ns.sentinel.converter.nmSerogroup'                   => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\NmSerogroup'),
            'ns.sentinel.converter.MeningVaccinationType'         => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\VaccinationType'),
            'ns.sentinel.converter.latResult'                     => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\LatResult'),
            'ns.sentinel.converter.isolateType'                   => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\IsolateType'),
            'ns.sentinel.converter.ibdCaseResult'                 => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\CaseResult'),
            'ns.sentinel.converter.hiSerotype'                    => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\HiSerotype'),
            'ns.sentinel.converter.gramStainResult'               => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\GramStainResult'),
            'ns.sentinel.converter.gramStain'                     => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\GramStain'),
            'ns.sentinel.converter.genotypeResultP'               => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\GenotypeResultP'),
            'ns.sentinel.converter.genotypeResultG'               => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\GenotypeResultG'),
            'ns.sentinel.converter.elisaKit'                      => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\ElisaKit'),
            'ns.sentinel.converter.elisaResult'                   => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\ElisaResult'),
            'ns.sentinel.converter.dischargeOutcome'              => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\DischargeOutcome'),
            'ns.sentinel.converter.dischargeClassification'       => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\DischargeClassification'),
            'ns.sentinel.converter.diagnosis'                     => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\Diagnosis'),
            'ns.sentinel.converter.dehydration'                   => new ArrayChoiceConverter('NS\SentinelBundle\Form\RotaVirus\Types\Dehydration'),
            'ns.sentinel.converter.cultureResult'                 => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\CultureResult'),
            'ns.sentinel.converter.caseStatus'                    => new ArrayChoiceConverter('NS\SentinelBundle\Form\Types\CaseStatus'),
            'ns.sentinel.converter.cxrResult'                     => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\CXRResult'),
            'ns.sentinel.converter.cxrAdditionalResult'           => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\CXRAdditionalResult'),
            'ns.sentinel.converter.binaxResult'                   => new ArrayChoiceConverter('NS\SentinelBundle\Form\IBD\Types\BinaxResult'),
