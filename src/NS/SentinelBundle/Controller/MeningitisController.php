...
class MeningitisController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sc->isGranted('ROLE_SITE'))
            $t = array( 'header_template'=>'NSSentinelBundle:Meningitis:indexSiteHeader.html.twig',
                        'row_template'=>'NSSentinelBundle:Meningitis:indexSiteRow.html.twig',
                        'action_template' => 'NSSentinelBundle:Meningitis:index-action.html.twig',
                        'action' => 'meningitisEdit');
        else if($sc->isGranted('ROLE_LAB'))
            $t = array( 'header_template'=>'NSSentinelBundle:Meningitis:indexSiteHeader.html.twig',
                        'row_template'=>'NSSentinelBundle:Meningitis:indexSiteRow.html.twig',
                        'action_template' => 'NSSentinelBundle:Meningitis:index-lab-action.html.twig',
                        'action' => 'meningitisLabEdit');
        else if($sc->isGranted('ROLE_RRL_LAB'))
            $t = array( 'header_template'=>'NSSentinelBundle:Meningitis:indexSiteHeader.html.twig',
                        'row_template'=>'NSSentinelBundle:Meningitis:indexSiteRow.html.twig',
                        'action_template' => 'NSSentinelBundle:Meningitis:index-rrl-action.html.twig',
                        'action' => 'meningitisRRLCreate');
        else if($sc->isGranted('ROLE_COUNTRY'))
            $t = array( 'header_template'=>'NSSentinelBundle:Meningitis:indexCountryHeader.html.twig',
                        'row_template'=>'NSSentinelBundle:Meningitis:indexCountryRow.html.twig',
                        'action_template' => 'NSSentinelBundle:Meningitis:index-action.html.twig',
                        'action' => '');
        else if($sc->isGranted('ROLE_REGION'))
            $t = array( 'header_template'=>'NSSentinelBundle:Meningitis:indexRegionHeader.html.twig',
                        'row_template'=>'NSSentinelBundle:Meningitis:indexRegionRow.html.twig',
                        'action_template' => 'NSSentinelBundle:Meningitis:index-action.html.twig',
                        'action' => '');
