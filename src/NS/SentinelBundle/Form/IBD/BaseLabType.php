...
class BaseLabType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('pathogenIdentifierMethod',   PathogenIdentifier::class, array('label' => 'ibd-rrl-form.pathogen-id-method', 'required' => false, 'hidden-child' => 'pathogenIdentifierMethod'))
            ->add('pathogenIdentifierOther',    null, array('label' => 'ibd-rrl-form.pathogen-id-other', 'required' => false, 'hidden-parent' => 'pathogenIdentifierMethod', 'hidden-value' => PathogenIdentifier::OTHER))
            ->add('serotypeIdentifier',         SerotypeIdentifier::class, array('label' => 'ibd-rrl-form.serotype-id-method', 'required' => false, 'hidden-child' => 'serotypeIdentifier'))
            ->add('serotypeIdentifierOther',    null, array('label' => 'ibd-rrl-form.serotype-id-other', 'required' => false, 'hidden-parent' => 'serotypeIdentifier', 'hidden-value' => SerotypeIdentifier::OTHER))
