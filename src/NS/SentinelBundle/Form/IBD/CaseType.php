...
class CaseType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('admDx',              'NS\SentinelBundle\Form\IBD\Types\Diagnosis', array('required' => $required, 'label' => 'ibd-form.adm-dx', 'attr' => array('hidden-child' => 'admissionDiagnosis')))
            ->add('admDxOther',         null, array('required' => $required, 'label' => 'ibd-form.adm-dx-other', 'attr' => array('hidden-parent' => 'admissionDiagnosis', 'hidden-value' => Diagnosis::OTHER)))
            ...
            ->add('hibReceived',        'NS\SentinelBundle\Form\Types\VaccinationReceived', array('required' => $required, 'label' => 'ibd-form.hib-received', 'attr' => array('hidden-child' => 'hibReceived')))
            ...
            ->add('csfCollectTime',     'time', array('widget' => 'single_text', 'required' => $required, 'label' => 'ibd-form.csf-collect-datetime', 'hidden-parent' => 'csfCollected', 'hidden-value' => TripleChoice::YES))
