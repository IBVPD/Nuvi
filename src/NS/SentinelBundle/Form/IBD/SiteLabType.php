...
class SiteLabType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('csfGramDone',        TripleChoice::class, ['required' => false, 'label' => 'ibd-form.csf-gram-done', 'exclude_choices'=> $isPaho ? [TripleChoice::UNKNOWN]:[]])
            ->add('csfGramStain',       GramStain::class, ['required' => false, 'label' => 'ibd-form.csf-gram-result', 'hidden' => ['parent' => 'csfGramDone', 'value' => TripleChoice::YES],'exclude_choices'=> $isPaho ? [GramStain::UNKNOWN]:[]])
            ->add('csfGramResult',      GramStainResult::class, ['required' => false, 'label' => 'ibd-form.csf-gram-result-organism', 'hidden' => ['parent' => 'csfGramStain', 'value' => [GramStain::GM_NEGATIVE, GramStain::GM_POSITIVE]], 'exclude_choices'=> $isPaho ? [GramStainResult::UNKNOWN]:[]])
