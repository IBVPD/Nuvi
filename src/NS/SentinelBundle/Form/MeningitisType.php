...
class MeningitisType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('onsetDate',null,array('required'=>false,'label'=>'meningitis-form.onset-date'))
            ->add('antibiotics',null,array('required'=>false,'label'=>'meningitis-form.antibiotics'))
            ...
            ->add('pneuStridor',null,array('required'=>false,'label'=>'meningitis-form.pneu-stridor'))
            ->add('pneuRespRate',null,array('required'=>false,'label'=>'meningitis-form.pneu-resp-rate'))
            ->add('pneuVomit',null,array('required'=>false,'label'=>'meningitis-form.pneu-vomit'))
            ->add('pneuMalnutrition',null,array('required'=>false,'label'=>'meningitis-form.pneu-malnutrition'))
            ...
            ->add('meningType',null,array('required'=>false,'label'=>'meningitis-form.men-type'))
