...
class CaseType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('birthdate',                  DatePickerType::class,      ['required'=>$required, 'label' => 'ibd-form.date-of-birth', 'hidden' => ['parent' => 'dob', 'value' => TripleChoice::YES], 'widget' => 'single_text'])
            ...
            ->add('symptomDiarrheaOnset',       DatePickerType::class,      ['required'=>$required, 'label'=>'rotavirus-form.symptomDiarrheaOnset',    'hidden' => ['parent' => 'vaccineReceived', 'value'=>  TripleChoice::YES]])
            ->add('symptomDiarrheaEpisodes',    null,                       ['required'=>$required, 'label'=>'rotavirus-form.symptomDiarrheaEpisodes', 'hidden' => ['parent' => 'vaccineReceived', 'value'=>  TripleChoice::YES]])
            ->add('symptomDiarrheaDuration',    null,                       ['required'=>$required, 'label'=>'rotavirus-form.symptomDiarrheaDuration', 'hidden' => ['parent' => 'vaccineReceived', 'value'=>  TripleChoice::YES]])
            ->add('symptomDiarrheaBloody',      TripleChoice::class,        ['required'=>$required, 'label'=>'rotavirus-form.symptomDiarrheaDuration', 'hidden' => ['parent' => 'vaccineReceived', 'value'=>  TripleChoice::YES]])
            ...
            ->add('vaccinationType',            VaccinationType::class,     [
                                                                                ...
                                                                                'hidden' => [
                                                                                    'parent' => 'vaccineReceived',
                                                                                    'value' => [VaccinationReceived::YES_CARD, VaccinationReceived::YES_HISTORY]]
            ])
            ->add('doses',                      ThreeDoses::class,          [
                                                                                'required'=>$required, 'label'=>'rotavirus-form.doses',
                                                                                'hidden' => [
                                                                                    'parent' => 'vaccineReceived',
                                                                                    'child' => 'vaccineReceivedDoses',
                                                                                    'value' => [VaccinationReceived::YES_CARD, VaccinationReceived::YES_HISTORY]]
            ])
            ->add('firstVaccinationDose',       DatePickerType::class,      [
                                                                                ...
                                                                                'hidden' => [
                                                                                    'parent' => 'vaccineReceivedDoses',
                                                                                    'value' => [ThreeDoses::ONE, ThreeDoses::TWO, ThreeDoses::THREE]]
            ])
            ->add('secondVaccinationDose',      DatePickerType::class,      [
                                                                                ...
                                                                                'hidden' => [
                                                                                    'parent' => 'vaccineReceivedDoses',
                                                                                    'value' => [ThreeDoses::TWO, ThreeDoses::THREE]]
            ])
