...
class CaseType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('rehydrationType',            Rehydration::class,             ['required' => $required, 'label' => 'rotavirus-form.rehydrationType', 'hidden' => ['parent' => 'rehydration', 'value' => [TripleChoice::YES]]])
            ->add('rehydrationOther',           null,                           ['required' => $required, 'label' => 'rotavirus-form.rehydrationOther', 'hidden' => ['parent' => 'rehydrationType', 'value' => [Rehydration::OTHER]]])
