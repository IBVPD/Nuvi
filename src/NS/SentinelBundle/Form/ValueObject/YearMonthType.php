...
class YearMonthType extends AbstractType implements DataMapperInterface
{
    ...
    {
        $builder
            ->add('year', null, ['label' => 'ibd-form.date-of-birth-years', 'required' => $options['required'], 'hidden' => ['parent' => 'dob', 'value' => TripleChoice::NO ]])
            ->add('month', null, ['label' => 'ibd-form.date-of-birth-months', 'required' => $options['required'], 'hidden' => ['parent' => 'dob', 'value' => TripleChoice::NO ]]);
