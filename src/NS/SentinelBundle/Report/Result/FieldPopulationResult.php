...
//by site_code: gen propbloodequal= (totalbloodequal/ totalcase)*100
    ...
    {
        return ($this->getTotalCases() > 0 && ($this->bloodCollectedCount>0 || $this->bloodResultCount>0)) ? (min([$this->bloodCollectedCount, $this->bloodResultCount])/$this->getTotalCases())*100:100;
    }
