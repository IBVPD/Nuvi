...
{
    public function testGetFieldKeyIsLowerCase(): void
    {
    ...
    public function testDuplicateTextOnlyItemIsDetected(): void
    {
        $file         = new File(tempnam(sys_get_temp_dir(), 'duplicate_test'));
        $uniqueFields = ['site', 'case_id'];
    ...
    public function testDuplicateObjectItemIsDetected(): void
    {
        $file = new File(tempnam(sys_get_temp_dir(), 'duplicate_test'));
        $site = new Site();
    ...
    public function testDuplicateObjectStoresState(): void
    {
